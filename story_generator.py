...
MOS_ROLES = [
    ...
    ("68W", "Combat Medic", "the platoon's lifeline, running to the wounded under fire with nothing but a Unit One medical kit and sheer courage"),
    ("25U", "Signal Support Specialist", "keeping the radios alive, ensuring commanders could communicate when the jungle ate every signal"),
    ("88M", "Motor Transport Operator", "hauling supplies and troops on roads that could become killing grounds at any bend"),
    ("35F", "Intelligence Analyst", "piecing together enemy movements from captured documents, interrogations, and aerial reconnaissance"),
]
